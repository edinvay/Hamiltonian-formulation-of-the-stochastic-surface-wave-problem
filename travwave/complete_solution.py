...
class Complete_solution(object):
    ...
    def __init__(self, equation, boundary_condition, size=32, init_size=256):
        ...
        self.navigation = navigation.Navigator(solve.solve, size=size)
    ...
    def plot_data(self): # prints out all (velocity, amplitude) vectors for computed solutions
